...
public class DefaultConfig extends Config {
    ...
    public boolean allowDeathMessages() {
        return get().getNode(WEBHOOK_SETTINGS, "playerDeath").getBoolean(false);
    }
    ...
    public boolean allowJoinMessages() {
        return get().getNode(WEBHOOK_SETTINGS, "playerJoin").getBoolean(false);
    }
    ...
    public boolean allowLeaveMessages() {
        return get().getNode(WEBHOOK_SETTINGS, "playerLeave").getBoolean(false);
    }
